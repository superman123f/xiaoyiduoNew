...
//    -------------------------角色--------------
    int getRolesCount(String userId, String status, String roleName); // 获取权限总数
    List<S_USER_ROLES> selectAllRoles(String userId, String status, String pageSize, String currentPage, String roleName); //分页查询
...
//    -------------------------用户角色--------------
    S_USER seeUserRoles(String userId, Model model); // 查看角色权限
