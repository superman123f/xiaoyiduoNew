            ...
            <div class="layui-form-item" style="text-align:center;">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input id="searchPermission" autocomplete="off" class="layui-input" placeholder="请输入权限名称" type="text" name="searchPermission" value="">
                    </div>
                </div>
...
<script>
    layui.use(['table', 'layer', 'form'], function(){
        ...
        var $ = layui.$, active =
            {
                reload: function () {
                    var permissionName = $('#searchPermission').val();//获取输入框的值

                    //执行重载
                    table.reload('permissionId', //与table中的id要一致
                        {
                            page:
                                {
                                    curr: 1 //重新从第 1 页开始
                                }
                            , where: { permissionName: permissionName}//这里传参  向后台
                            ,url: '/role/searchPermission'
                ...
                //批量删除
                deleteData: function() {
                    var checkStatus = table.checkStatus('permissionId') //此时的id为ender的id
                ...
                getCheckData: function(){
                    var checkStatus = table.checkStatus('permissionId') //此时的id为render的id,获取选中行状态
