...
(function(global, $, Crop) {
    ...
    */
    ...
    function _createDom($wrap, opt) {
        ...
        var $picker = $('<div class="crop-picker-wrap"><button class="crop-picker" type="button">修改头像</button></div>');
        ...
        var $cropPreview = $('<div class="crop-preview-container" style="border-radius:50%;"/>');
